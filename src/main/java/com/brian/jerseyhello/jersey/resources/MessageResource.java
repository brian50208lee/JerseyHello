...
import com.brian.jerseyhello.jersey.resources.bean.MessageFilterBean;
import com.brian.jerseyhello.core.services.MessageService;
...
public class MessageResource {
    MessageService messageService = new MessageService(DummyDatabase.getInstance());
